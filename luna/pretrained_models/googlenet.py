...
class LRN(Layer):
    ...
    def call(self, x, mask=None):
        ...
        if K.backend() == "theano":
            ...
            zeros = T.alloc(0.0, b, ch + 2 * half_n, r, c)
...
def create_googlenet(user_weight_path=None):
    ...
    pool1_3x3_s2 = MaxPooling2D(
        pool_size=(3, 3), strides=(2, 2), padding="valid", name="pool1/3x3_s2"
    )(pool1_helper)
    ...
    pool2_3x3_s2 = MaxPooling2D(
        pool_size=(3, 3), strides=(2, 2), padding="valid", name="pool2/3x3_s2"
    )(pool2_helper)
    ...
    inception_3a_pool = MaxPooling2D(
        pool_size=(3, 3), strides=(1, 1), padding="same", name="inception_3a/pool"
    )(pool2_3x3_s2)
    ...
    inception_3b_5x5 = Conv2D(
        ...
        kernel_regularizer=l2(0.0002),
    )(inception_3b_5x5_pad)
    inception_3b_pool = MaxPooling2D(
        pool_size=(3, 3), strides=(1, 1), padding="same", name="inception_3b/pool"
    )(inception_3a_output)
    ...
    pool3_3x3_s2 = MaxPooling2D(
        pool_size=(3, 3), strides=(2, 2), padding="valid", name="pool3/3x3_s2"
    )(pool3_helper)
    ...
    inception_4a_5x5 = Conv2D(
        ...
        kernel_regularizer=l2(0.0002),
    )(inception_4a_5x5_pad)
    inception_4a_pool = MaxPooling2D(
        pool_size=(3, 3), strides=(1, 1), padding="same", name="inception_4a/pool"
    )(pool3_3x3_s2)
    ...
    loss1_ave_pool = AveragePooling2D(
        pool_size=(5, 5), strides=(3, 3), name="loss1/ave_pool"
    )(inception_4a_output)
    loss1_conv = Conv2D(
        128,
        (1, 1),
    ...
    loss1_fc = Dense(
        1024, activation="relu", name="loss1/fc", kernel_regularizer=l2(0.0002)
    )(loss1_flat)
    loss1_drop_fc = Dropout(rate=0.7)(loss1_fc)
    loss1_classifier = Dense(
        1000, name="loss1/classifier", kernel_regularizer=l2(0.0002)
    )(loss1_drop_fc)
    ...
    inception_4b_5x5 = Conv2D(
        ...
        kernel_regularizer=l2(0.0002),
    )(inception_4b_5x5_pad)
    inception_4b_pool = MaxPooling2D(
        pool_size=(3, 3), strides=(1, 1), padding="same", name="inception_4b/pool"
    )(inception_4a_output)
    ...
    inception_4c_5x5 = Conv2D(
        ...
        kernel_regularizer=l2(0.0002),
    )(inception_4c_5x5_pad)
    inception_4c_pool = MaxPooling2D(
        pool_size=(3, 3), strides=(1, 1), padding="same", name="inception_4c/pool"
    )(inception_4b_output)
    ...
    inception_4d_pool = MaxPooling2D(
        pool_size=(3, 3), strides=(1, 1), padding="same", name="inception_4d/pool"
    )(inception_4c_output)
    ...
    loss2_ave_pool = AveragePooling2D(
        pool_size=(5, 5), strides=(3, 3), name="loss2/ave_pool"
    )(inception_4d_output)
    loss2_conv = Conv2D(
        128,
        (1, 1),
    ...
    loss2_fc = Dense(
        1024, activation="relu", name="loss2/fc", kernel_regularizer=l2(0.0002)
    )(loss2_flat)
    loss2_drop_fc = Dropout(rate=0.7)(loss2_fc)
    loss2_classifier = Dense(
        1000, name="loss2/classifier", kernel_regularizer=l2(0.0002)
    )(loss2_drop_fc)
    ...
    inception_4e_5x5 = Conv2D(
        ...
        kernel_regularizer=l2(0.0002),
    )(inception_4e_5x5_pad)
    inception_4e_pool = MaxPooling2D(
        pool_size=(3, 3), strides=(1, 1), padding="same", name="inception_4e/pool"
    )(inception_4d_output)
    ...
    pool4_3x3_s2 = MaxPooling2D(
        pool_size=(3, 3), strides=(2, 2), padding="valid", name="pool4/3x3_s2"
    )(pool4_helper)
    ...
    inception_5a_5x5 = Conv2D(
        ...
        kernel_regularizer=l2(0.0002),
    )(inception_5a_5x5_pad)
    inception_5a_pool = MaxPooling2D(
        pool_size=(3, 3), strides=(1, 1), padding="same", name="inception_5a/pool"
    )(pool4_3x3_s2)
    ...
    inception_5b_5x5 = Conv2D(
        ...
        kernel_regularizer=l2(0.0002),
    )(inception_5b_5x5_pad)
    inception_5b_pool = MaxPooling2D(
        pool_size=(3, 3), strides=(1, 1), padding="same", name="inception_5b/pool"
    )(inception_5a_output)
    ...
    pool5_7x7_s1 = AveragePooling2D(
        pool_size=(7, 7), strides=(1, 1), name="pool5/7x7_s2"
    )(inception_5b_output)
    loss3_flat = Flatten()(pool5_7x7_s1)
    pool5_drop_7x7_s1 = Dropout(rate=0.4)(loss3_flat)
    loss3_classifier = Dense(
        1000, name="loss3/classifier", kernel_regularizer=l2(0.0002)
    )(pool5_drop_7x7_s1)
